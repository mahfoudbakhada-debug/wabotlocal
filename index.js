...
function parseFecha(texto, from) {
  ...
  if(tieneDia){
    memoria.set(from, { fecha: new Date(fecha), ts: Date.now() });
  }
...
app.post('/whatsapp', async (req,res)=>{
  try {
    ...
    const fechaInicio = parseFecha(msg, from);
