...
// ESTA ES LA ÚNICA LÍNEA NUEVA QUE AÑADO
const DEMO_NAME = BUSINESS_SHORT.toLowerCase().includes('vip') || BUSINESS_SHORT.toLowerCase().includes('barber') || BUSINESS_NAME.toLowerCase().includes('barber')? "Oscar Martínez" : "Ana García";
